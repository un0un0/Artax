...
static const int64_t STATIC_POS_REWARD = 6 * COIN; //Constant reward of 6 ARTX per COIN
static const int64_t TARGET_SPACING = 1 * 65; // 65 sec per Block
static const int64_t TARGET_SPACING2 = 65; // 65 sec per Block
static const int64_t STAKE_TIMESPAN_SWITCH_TIME = 1508858115;
static const int64_t STAKE_TIMESPAN_SWITCH_TIME1 = 1517103087; 
