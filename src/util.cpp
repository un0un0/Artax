...
int nAnonymizeArtaxAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Artax.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "artaxd.pid"));
